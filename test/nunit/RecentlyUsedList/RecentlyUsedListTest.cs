...
namespace Katas.TheRecentlyUsedList_kata
{
    [TestFixture]
    ...
    public class RecentlyUsedListTest
    {
        ...
        public void CanAddItems()
        {
            ...
            _recentlyUsedList.Should().NotBeEmpty(because: "we add single item");
        }
        ...
        public void CanAddUniqueItems()
        {
            ...
            actuallist.Should().Equal("FifthItem", "FourthItem", "ThirdItem", "SecondItem", "FirstItem");
        }
        ...
        public void CanThrowArgumentExceptionWhenSuppliedIndexIsOutOfScope()
        {
            ...
            Assert.That(exception.Message,
                Is.EqualTo(string.Format("supplied index [{0}] should not greater than [{1}].", index,
                    _recentlyUsedList.Count - 1)));
        }
        ...
        public void CanThrowArgumentExceptionWhenSuppliedIndexContainNegativeValue()
        {
            ...
            var exception = Assert.Throws<ArgumentException>(() => _recentlyUsedList.GetListItem(index));
            Assert.That(exception.Message,
                Is.EqualTo(string.Format("supplied index [{0}] should be non-negative and not greater than [{1}].",
                    index, _recentlyUsedList.Count - 1)));

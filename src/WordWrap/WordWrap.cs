...
namespace Katas.TheWordWrapKata
{
    public class WordWrap
    {
        ...
        private static string GetWrappedwordWithoutBlankSpacesAtStartOfNewLine(string wrappedword)
        {
            ...
            for (var outCounter = 0; outCounter < wrappedword.Length; outCounter++)
            {
                ...
                newWrappedWord = RemoveWhiteSpacesFromWrappedWord(wrappedword, outCounter, spaceCounter);
                    //RemoveWhiteSpacesFromWrappedWord(wrappedword, outCounter + 1, spaceCounter);
